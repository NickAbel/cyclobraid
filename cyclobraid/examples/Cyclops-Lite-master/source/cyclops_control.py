...
def make_control():
    ...
    **Returns**
    ...
    # Physical Parameters
    control['epsilon'] = 1.  # Scale separation
    control['deformation_radius'] = 1.0 # Rossby deformation radius (must be O(1))
    ...
    # N_bar reuse storage dicts
    control['index'] = 0 # Spatial index of current my_Step() call
    control['iteration'] = 0 # Iteration number of current my_step() call
    control['UhatNL1'] = { } # Values of Uhat_NL_1 (see RSWE_direct.py) per iter and index
    control['UhatNL2'] = { } # Values of Uhat_NL_2 (see RSWE_direct.py) per iter and index
